...
public class CustomTableCell extends TableCell<GroceryItemResource, Boolean> {
    ...
    public CustomTableCell(TableCellEnum tableCellEnum) {
        this.button = new JFXButton(StringUtils.EMPTY, new ImageView(new Image(Objects.requireNonNull(getClass().getResourceAsStream(tableCellEnum.getIcon())),//
                tableCellEnum.getWidth(),//
                tableCellEnum.getHeight(),//
                tableCellEnum.isPreserveRatio(),//
                tableCellEnum.isSmooth())));
    }
