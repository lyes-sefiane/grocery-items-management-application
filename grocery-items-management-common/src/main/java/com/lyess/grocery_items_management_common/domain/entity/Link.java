...
public class Link extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7529041588255371731L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Link\",\"namespace\":\"com.lyess.grocery_items_management_common.domain.entity\",\"fields\":[{\"name\":\"rel\",\"type\":\"string\"},{\"name\":\"href\",\"type\":\"string\"}]}");
   ...
   */
  public static com.lyess.grocery_items_management_common.domain.entity.Link.Builder newBuilder() {
    return new com.lyess.grocery_items_management_common.domain.entity.Link.Builder();
  }
   ...
   * @return A new Link RecordBuilder
   */
  public static com.lyess.grocery_items_management_common.domain.entity.Link.Builder newBuilder(com.lyess.grocery_items_management_common.domain.entity.Link.Builder other) {
    if (other == null) {
      return new com.lyess.grocery_items_management_common.domain.entity.Link.Builder();
    } else {
      return new com.lyess.grocery_items_management_common.domain.entity.Link.Builder(other);
    }
  }
   ...
   * @return A new Link RecordBuilder
   */
  public static com.lyess.grocery_items_management_common.domain.entity.Link.Builder newBuilder(com.lyess.grocery_items_management_common.domain.entity.Link other) {
    if (other == null) {
      return new com.lyess.grocery_items_management_common.domain.entity.Link.Builder();
    } else {
      return new com.lyess.grocery_items_management_common.domain.entity.Link.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Link>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.lyess.grocery_items_management_common.domain.entity.Link.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.lyess.grocery_items_management_common.domain.entity.Link other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.rel)) {
        this.rel = data().deepCopy(fields()[0].schema(), other.rel);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lyess.grocery_items_management_common.domain.entity.Link.Builder setRel(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lyess.grocery_items_management_common.domain.entity.Link.Builder clearRel() {
      rel = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lyess.grocery_items_management_common.domain.entity.Link.Builder setHref(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lyess.grocery_items_management_common.domain.entity.Link.Builder clearHref() {
      href = null;
